...
var TaskList = /*#__PURE__*/function () {
  ...
  _createClass(TaskList, [{
    ...
    value: function renderScraps() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var position = this.scraps.indexOf(scrap);
    ...
    key: "createScrapCard",
    value: function createScrapCard(title, message, position) {
      return "\n        <div class=\"message-cards card text-white bg-dark m-2\">\n            <div class=\"card-header font-weight-bold\">".concat(title, "</div>\n            <div class=\"card-body\">\n                <p class=\"card-text\">\n                    ").concat(message, "\n                </p>\n            </div>\n            <div class=\"w100 d-flex justify-content-end pr-2 pb-2\">\n                <button class=\"btn btn-danger mr-1\" onclick=\"deleteCard(").concat(position, ")\">\n                    Deletar\n                </button>\n                <button class=\"btn btn-info\" onclick=\"openEditModal(").concat(position, ")\">\n                    Editar\n                </button>\n            </div>\n        </div>\n        ");
    }
  }]);
